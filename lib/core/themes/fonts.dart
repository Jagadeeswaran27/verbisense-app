...
extension ThemeExtension on TextTheme {
  ...
  TextStyle get headlineSmallRegularGrey => headlineSmall!.copyWith(
    fontWeight: FontWeight.w400,
  ...
  TextStyle get bodyMediumBoldWhite => bodyMedium!.copyWith(
  ...
  TextStyle get displayMediumStrongWhite => displayMedium!.copyWith(
    fontWeight: FontWeight.w500,
    color: ThemeColors.white,
  );
